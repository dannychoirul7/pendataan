...
<body>
  ...
  <div class="p-4" id="main-content">
    ...
    <div class="card mt-5">
      <div class="card-body">
        <h1 style="text-align:center">Data Barang Belum Tervalidasi</h1>
            ...
            <?php foreach ($barang_sementara as $row) : ?>
              <tr>
                ...
                <td style="text-align: center">
                  <a class="btn btn-sm btn-dark" href="detail.php?id_barang_sementara=<?= $row["id_barang_sementara"]; ?>" role="button">Lihat Detail</a>
                </td>
              </tr>
            <?php $no++;
            endforeach; ?>
