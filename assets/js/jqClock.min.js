...
Date.prototype.hasOwnProperty("stdTimezoneOffset") ||
  ((Date.prototype.stdTimezoneOffset = function () {
    ...
    if (!Date.prototype.stdTimezoneOffset.cache.hasOwnProperty(c)) {
      for (var d = new Date(c, 0, 1).getTimezoneOffset(), f = [6, 7, 5, 8, 4, 9, 3, 10, 2, 11, 1], k = 0; 12 > k; k++) {
...
Date.prototype.hasOwnProperty("getWOY") ||
  (Date.prototype.getWOY = function (c) {
    ...
    return c ? d.getFullYear() : Math.ceil(((d - new Date(d.getFullYear(), 0, 1)) / 864e5 + 1) / 7);
  });
Date.prototype.hasOwnProperty("swatchTime") ||
  (Date.prototype.swatchTime = function () {
    return ("00" + Math.floor((60 * (((this.getUTCHours() + 1) % 24) * 60 + this.getUTCMinutes()) + this.getUTCSeconds() + 0.001 * this.getUTCMilliseconds()) / 86.4)).slice(-3);
  });
...
(function (c) {
  c.clock = {
    ...
    options: [
      ...
      { type: "string", value: "stop", description: "Passing in 'stop' to an already initialized clock will clear the setTimeout for that clock to stop it from ticking" },
      { type: "string", value: "start", description: "Passing in 'start' to an already initialized clock will restart the setTimeout for that clock to get it ticking again, as though it had never lost time" },
      {
        type: "object",
        ...
        values: [
          ...
          { name: "calendar", description: "Whether the date should be displayed together with the time", type: "Boolean", values: [!0, !1] },
          { name: "dateFormat", description: "PHP Style Format string for formatting a local date, see http://php.net/manual/en/function.date.php", type: "String", values: "dDjlNSwzWFmMntLoYy".split("") },
          { name: "timeFormat", description: "PHP Style Format string for formatting a local date, see http://php.net/manual/en/function.date.php", type: "String", values: "aABgGhHisveIOPZcrU".split("") },
          {
            name: "isDST",
            description:
          ...
          { name: "rate", description: "Defines the rate at which the clock will update, in milliseconds", type: "Integer", values: "1 - 9007199254740991 (recommended 10-60000)" },
        ],
      },
    ],
    methods: {
  ...
  c.fn.clock = function (f) {
    ...
    var q = {
        ...
        D: function (a) {
          return new Intl.DateTimeFormat(a.myoptions.langSet, { weekday: "short" }).format(a.mytimestamp_sysdiff);
        },
        j: function (a) {
          return a.dt;
        },
        l: function (a) {
          return new Intl.DateTimeFormat(a.myoptions.langSet, { weekday: "long" }).format(a.mytimestamp_sysdiff);
        },
        N: function (a) {
        ...
        S: function (a) {
          a = a.dt;
          return 1 === a || (1 === a % 10 && 11 != a) ? "st" : 2 === a || (2 === a % 10 && 12 != a) ? "nd" : 3 === a || (3 === a % 10 && 13 != a) ? "rd" : "th";
        },
        w: function (a) {
          return a.dy;
        },
        ...
        F: function (a) {
          return new Intl.DateTimeFormat(a.myoptions.langSet, { month: "long" }).format(a.mytimestamp_sysdiff);
        },
        m: function (a) {
          return (a.mo + 1 + "").padStart(2, "0");
        },
        M: function (a) {
          return new Intl.DateTimeFormat(a.myoptions.langSet, { month: "short" }).format(a.mytimestamp_sysdiff);
        },
        n: function (a) {
          return a.mo + 1;
        },
      ...
      r = {
        ...
        O: function (a) {
          return (0 > a.tzH ? "+" + ("" + Math.abs(a.tzH)).padStart(2, "0") : 0 < tzH ? ("" + -1 * a.tzH).padStart(2, "0") : "+00") + "00";
        },
        P: function (a) {
          return (0 > a.tzH ? "+" + ("" + Math.abs(a.tzH)).padStart(2, "0") : 0 < a.tzH ? ("" + -1 * a.tzH).padStart(2, "0") : "+00") + ":00";
        },
        Z: function (a) {
          return 0 > a.tzS ? "" + Math.abs(a.tzS) : 0 < a.tzS ? "" + -1 * a.tzS : "0";
        },
        c: function (a) {
          return (
            a.y +
            ...
            ":" +
            ("" + a.s).padStart(2, "0") +
            (0 > a.tzH ? "+" + ("" + Math.abs(a.tzH)).padStart(2, "0") : 0 < tzh ? ("" + -1 * a.tzh).padStart(2, "0") : "+00") +
            ":00"
          );
        },
        r: function (a) {
          return (
            new Intl.DateTimeFormat(a.myoptions.langSet, { weekday: "short" }).format(a.mytimestamp_sysdiff) +
            ", " +
            a.dt +
            " " +
            new Intl.DateTimeFormat(a.myoptions.langSet, { month: "short" }).format(a.mytimestamp_sysdiff) +
            " " +
            a.y +
            " " +
            ("" + a.h).padStart(2, "0") +
            ...
            ("" + a.s).padStart(2, "0") +
            " " +
            (0 > a.tzH ? "+" + ("" + Math.abs(a.tzH)).padStart(2, "0") : 0 < a.tzh ? ("" + -1 * a.tzh).padStart(2, "0") : "+00") +
            "00"
          );
        },
        U: function (a) {
      ...
      n = {
        destroy: function (a) {
          ...
          c(a).html("");
          c(a).hasClass("jqclock") && c(a).removeClass("jqclock");
      ...
      p = function (a) {
        ...
        b.correction = b.currentTzOffset === b.myoptions.tzOffset ? 0 : 6e4 * (b.currentTzOffset - b.myoptions.tzOffset);
        b.pfnow = performance.now();
        b.mytimestamp = performance.timeOrigin + b.pfnow + b.myoptions.sysdiff + b.correction;
      ...
      w = function (a) {
        for (var b = "", e, g = a.myoptions, h = 0; h <= g.dateFormat.length; h++)
        ...
        return '<span class="clockdate">' + b + "</span>";
      },
      x = function (a) {
        for (var b = "", e, g = a.myoptions, h = 0; h <= g.timeFormat.length; h++)
      ...
      t = function (a, b, e, g, h) {
        var l = b + 1;
        for (a = e ? a.dateFormat : a.timeFormat; l < a.length && "%" != a.charAt(l); ) l++;
        l > b + 1 && l != a.length ? ((g += a.substring(b + 1, l)), (b += l - b)) : (g += h);
        return [g, b];
      },
      u = function (a, b) {
        a.timezone = "UTC";
        ...
        0 > b ? (a.timezone += "+" + Math.abs(b) + ("" !== g ? ":" + g : "")) : 0 < b && (a.timezone += -1 * b + ("" !== g ? ":" + g : ""));
        return a;
      };
    this.each(function () {
      if ("undefined" === typeof f || "object" === typeof f) {
        ...
        b.dateFormat = b.dateFormat || ("en" == b.langSet ? "l, F j, Y" : "l, j F Y");
        b.timeFormat = b.timeFormat || ("en" == b.langSet ? "h:i:s A" : "H:i:s");
        ...
        "string" === typeof b.calendar ? (b.calendar = "false" == b.calendar ? !1 : !0) : "boolean" !== typeof b.calendar && (b.calendar = !!b.calendar);
        ...
        "string" === typeof b.isDST ? (b.isDST = "true" == b.isDST ? !0 : !1) : "boolean" !== typeof b.isDST && (b.isDST = !!b.isDST);
        ...
        if ("localsystime" != f.timestamp) {
          ...
          2 < (a.getTime() + "").length - (e.timestamp + "").length
            ? ((a = f), (a.timestamp *= 1e3), (a.sysdiff = a.timestamp - (void 0).getTime() + 6e4 * a.tzOffset), (f = a))
            : ((f.sysdiff = f.timestamp - a.getTime()), "localsystimezone" == f.timezone && (f = u(f, b)));
        } else "localsystimezone" == f.timezone && (f = u(f, b));
        a = f;
        c(k).hasClass("jqclock") || c(k).addClass("jqclock");
        c(k).is("[id]") || c(k).attr("id", v());
        c(k).data("clockoptions", a);
        !1 === d.hasOwnProperty(c(k).attr("id")) && p(c(k));
      } else if ("string" === typeof f)
        if (f in n) n[f](k);
        else console.error("You are calling an undefined method on a jqClock instance");
    });
